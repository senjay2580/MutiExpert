...
from app.api import industries, knowledge_bases, documents, chat, network, feishu, skills, calendar, dashboard, system, scheduled_tasks, todos, site_settings, data_management, boards, scripts, bot_tools, sandbox, external_services
...
api_router.include_router(external_services.router, prefix="/external-services", tags=["external-services"])
