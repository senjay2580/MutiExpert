...
type SidebarStateContextProps = Pick<
  SidebarContextProps,
  "state" | "open" | "isMobile"
>
type SidebarMobileContextProps = Pick<SidebarContextProps, "openMobile">
type SidebarActionsContextProps = Pick<
  SidebarContextProps,
  "setOpen" | "setOpenMobile" | "toggleSidebar"
>

const SidebarStateContext = React.createContext<SidebarStateContextProps | null>(
  null
)
const SidebarMobileContext =
  React.createContext<SidebarMobileContextProps | null>(null)
...
function SidebarProvider({
  ...
  const mobileValue = React.useMemo<SidebarMobileContextProps>(
    () => ({ openMobile }),
    [openMobile]
  )
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Icon icon="streamline-color:insert-side" />
